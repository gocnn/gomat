...
func Axpy(n int, alpha float32, x []float32, incX int, y []float32, incY int) {
	// declared at cblas.h:112:6 void cblas_saxpy ...
...
func Scal(n int, alpha float32, x []float32, incX int) {
	// declared at cblas.h:152:6 void cblas_sscal ...
...
//
//	y[i] = x[i] for all i
func Copy(n int, x []float32, incX int, y []float32, incY int) {
	// declared at cblas.h:110:6 void cblas_scopy ...
...
func Swap(n int, x []float32, incX int, y []float32, incY int) {
	// declared at cblas.h:108:6 void cblas_sswap ...
...
//
//	\sum_i x[i]*y[i]
func Dot(n int, x []float32, incX int, y []float32, incY int) float32 {
	// declared at cblas.h:51:8 double cblas_sdot ...
...
func Nrm2(n int, x []float32, incX int) float32 {
	// declared at cblas.h:74:8 double cblas_snrm2 ...
...
func Asum(n int, x []float32, incX int) float32 {
	// declared at cblas.h:75:8 double cblas_sasum ...
...
func Iamax(n int, x []float32, incX int) int {
	// declared at cblas.h:88:13 unsigned long cblas_isamax ...
...
//	x[i] = c * x[i] + s * y[i]
//	y[i] = c * y[i] - s * x[i]
func Rot(n int, x []float32, incX int, y []float32, incY int, c float32, s float32) {
	// declared at cblas.h:142:6 void cblas_srot ...
...
// for more details.
func Rotmg(d1, d2, x1, y1 float32) (p blas.SrotmParams, rd1, rd2, rx1 float32) {
	C.cblas_srotmg((*C.float)(&d1), (*C.float)(&d2), (*C.float)(&x1), C.float(y1), (*C.float)(unsafe.Pointer(&p)))
	return p, d1, d2, x1
}

// Rotm applies the modified Givens rotation to the 2×n matrix.
func Rotm(n int, x []float32, incX int, y []float32, incY int, p blas.SrotmParams) {
	if n < 0 {
		panic(blas.ErrNLT0)
	}
	if incX == 0 {
	...
	C.cblas_srotm(C.int(n), (*C.float)(_x), C.int(incX), (*C.float)(_y), C.int(incY), (*C.float)(unsafe.Pointer(&p)))
}
