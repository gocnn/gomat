...
//go:generate go run . -bits 64 -out ../../mat/div_amd64.s -stubs ../../mat/div_amd64.go -pkg mat
//go:generate go run . -bits 32 -out ../../mat32/div_amd64.s -stubs ../../mat32/div_amd64.go -pkg mat32
