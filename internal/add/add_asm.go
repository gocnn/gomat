...
//go:generate go run . -bits 64 -out ../../mat/add_amd64.s -stubs ../../mat/add_amd64.go -pkg mat
//go:generate go run . -bits 32 -out ../../mat32/add_amd64.s -stubs ../../mat32/add_amd64.go -pkg mat32
