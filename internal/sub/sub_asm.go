...
//go:generate go run . -bits 64 -out ../../mat/sub_amd64.s -stubs ../../mat/sub_amd64.go -pkg mat
//go:generate go run . -bits 32 -out ../../mat32/sub_amd64.s -stubs ../../mat32/sub_amd64.go -pkg mat32
